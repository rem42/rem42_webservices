...
class Rem42WebserviceTntOrder
{
    ...
    public function execute() {
        ...
        if(strlen($this->input->urlSegment[3]) > 0) {
            $order = TNTOfficielOrder::loadOrderID($this->input->urlSegment[3], false);
            $this->webserviceReturn->string .= $this->output->renderEntity($order, null);
        }
